...
<head>
    ...
    <title>Konfirmasi Pendaftaran Kuliah</title>
    <style>
        ul {
            line-height: 28px;
        }
...
<body>
    <main>
        <header>
            ...
            <p>Selamat! Kami dengan senang hati menginformasikan bahwa proses pendaftaran kuliah Anda telah berhasil. Berikut adalah rincian pendaftaran Anda:</p>
        </header>
        <ul>
            <li>
                <strong>No. Kwitansi:</strong>
                <span>{{ $data['receipt'] ?? '0000000000' }}</span>
            </li>
            <li>
